...
var fingerprintModal = /*#__PURE__*/function (_Modal) {
  ...
  _proto.title = function title() {
    return flarum_forum_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('modal.title');
  };
...
/* harmony import */ var flarum_forum_components_UserPage__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! flarum/forum/components/UserPage */ "flarum/forum/components/UserPage");
/* harmony import */ var flarum_forum_components_UserPage__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(flarum_forum_components_UserPage__WEBPACK_IMPORTED_MODULE_5__);
...
/* harmony import */ var _components_fingerprintModal__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/fingerprintModal */ "./src/forum/components/fingerprintModal.tsx");
/* harmony import */ var _common_models_FingerprintRecord__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../common/models/FingerprintRecord */ "./src/common/models/FingerprintRecord.ts");
...
function getFingerForUser(id) {
  return function () {
    return flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().store.find(_common_models_FingerprintRecord__WEBPACK_IMPORTED_MODULE_8__["default"].TYPE, id);
  };
}
function getSuspiciousForUser(id) {
  return function () {
    return flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().request({
      method: 'GET',
      url: flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().forum.attribute('apiUrl') + ("/fingerprint-records/" + id + "/suspicious")
    });
  };
}
function addItem(items, userId) {
  if (userId && flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().forum.attribute('xypp-fingerprint-recorder.view')) {
    var user = flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().store.getById('users', userId + "");
    items.add('fingerprint-recorder-fingerprint', flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_2___default().component({
      icon: 'fas fa-users-cog',
      className: 'Button Button--link',
      onclick: function onclick() {
        flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().modal.show(_components_fingerprintModal__WEBPACK_IMPORTED_MODULE_7__["default"], {
          getData: getFingerForUser(userId),
          title: flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans('xypp-fingerprint-recorder.forum.finger_title')
        });
      }
    }, flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans('xypp-fingerprint-recorder.forum.show', {
      cnt: user && user.attribute('fingerprint_count') || 0
    })));
    items.add('fingerprint-recorder-suspicious', flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_2___default().component({
      icon: 'fas fa-exclamation-triangle',
      className: 'Button Button--link',
      onclick: function onclick() {
        flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().modal.show(_components_fingerprintModal__WEBPACK_IMPORTED_MODULE_7__["default"], {
          getData: getSuspiciousForUser(userId),
          title: flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans('xypp-fingerprint-recorder.forum.suspicious_title')
        });
      }
    }, flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans('xypp-fingerprint-recorder.forum.suspicious', {
      cnt: user && user.attribute('fingerprint_suspicious') || 0
    })));
  }
}
flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().initializers.add('xypp/flarum-fingerprint-recorder', function () {
  (0,_common_addFingerprintHeader__WEBPACK_IMPORTED_MODULE_1__.addFingerprintHeader)();
  (0,flarum_common_extend__WEBPACK_IMPORTED_MODULE_6__.extend)((flarum_forum_utils_PostControls__WEBPACK_IMPORTED_MODULE_3___default()), "moderationControls", function (items, post) {
    var user = post.user();
    var userId = user && user.id();
    addItem(items, userId);
  });
  (0,flarum_common_extend__WEBPACK_IMPORTED_MODULE_6__.extend)((flarum_forum_utils_DiscussionControls__WEBPACK_IMPORTED_MODULE_4___default()), 'moderationControls', function (items, discussion) {
    var user = discussion.user();
    var userId = user && user.id();
    addItem(items, userId);
  });
  (0,flarum_common_extend__WEBPACK_IMPORTED_MODULE_6__.extend)((flarum_forum_components_UserPage__WEBPACK_IMPORTED_MODULE_5___default().prototype), 'navItems', function (items) {
    if ((flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().session).user) {
      addItem(items, flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().session.user.id());
    }
  });
});
